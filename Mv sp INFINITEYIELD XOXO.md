...
Title.TextSize = 18
Title.Text = "Infinite Yield Xoxovtrung v" .. currentVersion
...
CMDs[#CMDs + 1] = {NAME = 'hitbox [plr] [size]', DESC = 'Expands the hitbox for players HumanoidRootPart (default is 0.6)'}
CMDs[#CMDs + 1] = {NAME = 'headsize [plr] [size]', DESC = 'Expands the head size for players Head (default is 0.6)'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
